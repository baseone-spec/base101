...
<body>
    ...
    <div class="container w-full lg:grid-cols-4 h-auto text-[#2D2D2D] text-center">
        ...
        <div
            class="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xl:px-30 xl:py-20  lg:px-20 lg:py-20 md:py-20 sm:py-20 w-full h-auto justify-center place-items-center">
    ...
    <div class="container w-full lg:grid-cols-4 h-auto text-[#2D2D2D] text-center">
        ...
        <div
            ...
            <div class="group relative shadow-xl p-6 justify-center align-content place-items-center h-full">
